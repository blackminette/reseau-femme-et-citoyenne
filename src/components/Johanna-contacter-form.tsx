...
export default function ContacterForm() {
        ...
        <div className="w-full bg-[#eedeff] min-h-screen py-12 px-4 sm:px-8">
            ...
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='text-center space-y-2 mt-5'>
                    <h1 className='text-5xl font-black leading-[1.1]'>Restons en lien!</h1>

                    <h2 className='text-2xl font-medium'>Une question, une idée, un projet? Ecrivons ensemble l'avenir</h2>
                </div>
                ...
                {/* ================= COLONNE GAUCHE : NOUS CONTACTER ================= */}
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <div className="bg-[#260936]/80 text-white text-center py-3 px-6 rounded-md font-semibold tracking-wide shadow-sm">
                        NOUS CONTACTER</div>  
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-purple-50/50 space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-[#ffd166] text-[#260936] rounded-full shrink-0">
                            ...
                            <div className="pt-4 border-t border-gray-100">
                                ...
                                <div className="flex justify-center lg:justify-start gap-3">
                                    ...
                                    <a 
                                        ...
                                        className="p-2 bg-[#260936] text-white rounded-full hover:bg-[#ffd166] hover:text-[#260936] transition" aria-label='Instragram'>
                                    ...
                                    <a 
                                        ...
                                        className="p-2 bg-[#260936] text-white rounded-full hover:bg-[#ffd166] hover:text-[#260936] transition aria-label='Facebook">
                                        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <a 
                                        ...
                                        className="p-2 bg-[#260936] text-white rounded-full hover:bg-[#ffd166] hover:text-[#260936] transition aria-label='Linkedin">
                                        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl shadow-sm border border-purple-50/50 space-y-5">
                            ...
                            <div className="flex justify-center pt-2">
                                <button
                                    ...
                                    className="w-full sm:w-auto min-w-[240px] bg-[#260936] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#bc96e6] transition flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed text-sm uppercase tracking-wider"
                                >
