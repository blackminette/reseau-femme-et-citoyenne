...
import { submitResetRequestAction } from "./actions";
...
export default function ResetPasswordPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const result = await submitResetRequestAction({ username, message });
                                    ...
                                    <Field>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <Input
                                                id="username"
                                                type="text"
                                                placeholder="Votre pseudo (ex: johanna_admin)"
                                                required
                                                value={username}
                                    ...
                                    <Field>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-slate-50 border border-slate-200 text-slate-900 pl-10 pt-3 text-sm focus:border-[#260936] focus:ring-1 focus:ring-[#260936] focus:outline-none transition-all rounded-xl resize-none"
                                            />
                                        </div>
                                    </Field>
