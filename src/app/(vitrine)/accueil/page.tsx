    ...
    return (
        <div className="bg-[#eedeff] pb-16 grow">
            ...
            <section className="relative min-h-[90vh] w-full bg-[url('/background.png')] bg-cover bg-center text-white flex items-center">
                ...
                <div className="absolute inset-0 bg-linear-to-b from-[#260936]/90 via-[#260936]/60 to-[#260936]/30"></div>
                ...
                <div className="relative z-10 w-full px-8 text-center max-w-7xl mx-auto py-20">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6 items-center">
                        <a
                            href="/ateliers"
                            className="w-full sm:w-auto px-10 py-4 bg-[#ffd166] text-[#260936] font-bold rounded-full transition hover:scale-105 shadow-xl flex items-center justify-center gap-2"
                        >
                ...
                >
                    ...
                    <div className="animate-bounce p-2 bg-[#260936]/20 rounded-full backdrop-blur-sm">
            ...
            >
                ...
                <div className="grid gap-12 md:grid-cols-[350px_1fr] items-center text-left">
                    <h2 className="text-4xl font-black text-[#260936] leading-[1.1]">
                        Notre mission <br />
                ...
                <div className="mt-24">
                    <div className="flex flex-col items-center mb-16">
                        <h3 className="text-3xl font-black text-[#260936] mb-2">Notre Impact</h3>
                    ...
                    <div className="grid gap-10 text-center sm:grid-cols-3">
                        <div className="group p-8 rounded-2rem bg-[#eedeff]/40 border border-[#bc96e6]/20 transition hover:bg-white hover:shadow-xl hover:-translate-y-1">
                            <div className="text-5xl font-black text-[#260936] mb-2 group-hover:scale-110 transition">150+</div>
                        ...
                        <div className="group p-8 rounded-2rem bg-[#ffd166]/15 border border-[#ffd166]/40 transition hover:bg-white hover:shadow-xl hover:-translate-y-1">
                            <div className="text-5xl font-black text-[#260936] mb-2 group-hover:scale-110 transition">1200</div>
                        ...
                        <div className="group p-8 rounded-2rem bg-[#bc96e6]/10 border border-[#bc96e6]/25 transition hover:bg-white hover:shadow-xl hover:-translate-y-1">
                            <div className="text-5xl font-black text-[#260936] mb-2 group-hover:scale-110 transition">45</div>
            ...
            <section className="mx-4 my-16 rounded-[2.5rem] bg-[#260936] p-8 md:p-20 text-center text-white shadow-2xl max-w-7xl md:mx-auto relative overflow-hidden">
            ...
            <section className="mx-4 mt-16 rounded-[2.5rem] bg-white p-8 md:p-20 text-center text-gray-800 shadow-2xl max-w-7xl md:mx-auto overflow-hidden relative">
                ...
                <div className="relative z-10">
                    <h2 className="mb-4 text-4xl font-black text-[#260936]">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        ...
                        <div className="group p-10 rounded-3xl bg-white border border-[#bc96e6]/20 flex flex-col items-center shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300">
                            <div className="mb-8 p-5 bg-[#260936]/5 rounded-2xl group-hover:bg-[#260936] transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#260936] group-hover:text-white transition-colors"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                            </div>
            ...
            <section className="mx-4 my-16 rounded-[2.5rem] bg-white p-8 md:p-20 text-center text-gray-800 shadow-2xl max-w-7xl md:mx-auto">
                <h2 className="mb-12 text-4xl font-black text-[#260936]">
                    Nous trouver
                </h2>
                ...
                <div className="grid gap-12 md:grid-cols-2 text-left">
                    ...
                    <div className="group">
                        ...
                        <div className="mt-8 flex gap-5 items-start">
                            <div className="bg-[#260936] p-4 rounded-2xl text-white shadow-lg">
                            ...
                            <div>
                                <p className="font-black text-xl text-[#260936] mb-1">Associations Saint Roch</p>
                                <p className="text-slate-600 font-medium">50 Boulevard Saint-Roch, Nice</p>
                                <div className="mt-3 inline-block px-3 py-1 bg-[#260936]/10 text-[#260936] text-xs font-bold rounded-full uppercase tracking-widest">Siège Principal</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="group">
                        ...
                        <div className="mt-8 flex gap-5 items-start">
                            <div className="bg-[#ffd166] p-4 rounded-2xl text-[#260936] shadow-lg border border-[#ffd166]/50">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                            </div>
                            <div>
                                <p className="font-black text-xl text-[#260936] mb-1">CR Bensa</p>
                                <p className="text-slate-600 font-medium">Nice Centre-Ville</p>
                                <div className="mt-3 inline-block px-3 py-1 bg-[#ffd166]/30 text-[#260936] text-xs font-bold rounded-full uppercase tracking-widest">Annexe Ateliers</div>
                            </div>
                        </div>
                    </div>
                </div>
